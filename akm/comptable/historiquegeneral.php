...
<head>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header card-default">
                          Mes depots du <?php $da = date('Y-m-d'); echo $da ?>
   ...
   <?php 
   $date_o = date('Y-m-d');
                        $service = $db->prepare('SELECT * FROM depot INNER JOIN tbl_agent ON depot.id_user=tbl_agent.id_utilisateur WHERE id_agent=:id_agent ORDER BY id_depot DESC');
