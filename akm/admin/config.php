            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="mySmallModalLabel">Nouveau type</h5>
                    </div>
                    <div class="modal-body">
                        <form action="config" method="post">
                            <input class="form-control" type="text" name="ndomaine" id="" placeholder="nom du type" required="">
                    </div>
