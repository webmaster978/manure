            ...
            if($statement->rowCount() > 0)
             {
                echo "<script>
                         Swal.fire({
                          icon: 'error',
                           title: 'Oops...',
                      text: 'Cette mutualite existe deja!',
                         footer: ''
                          })
                  </script>";
             }
                ...
                if ($res) {
                    echo "<script>
                        Swal.fire({
                             position: 'top-end',
                             icon: 'success',
                             title: 'mutualite inserer avec success',
        ...
        if ($resultat) {
            echo "<script>
                Swal.fire({
                     position: 'top-end',
                     icon: 'success',
                     title: 'montant inserer avec success',
                    showConfirmButton: false,
                     timer: 1500
                   })
        ...
        if ($resulta) {
            echo "<script>
                Swal.fire({
                     position: 'top-end',
                     icon: 'success',
                     title: 'zone inserer avec success',
                    showConfirmButton: false,
                     timer: 1500
                   })
        ...
        <section class="main-content">
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h5 class="modal-title" id="mySmallModalLabel">Nouveau mutualites</h5>
                    </div>
                    <div class="modal-body">
                        <form action="config" method="post">
                            <input class="form-control" type="text" name="ndomaine" id="" placeholder="nom du mutualites" required="">
                    </div>
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" class="fa fa-times"></span></button>
                        <h5 class="modal-title" id="mySmallModalLabel">Nouveau montant</h5>
                    </div>
                    <div class="modal-body">
                        <form action="config" method="post">
                            <input class="form-control" type="number" name="ngrade" id="" placeholder="Montant" required="">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Fermer</button>
            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true" class="fa fa-times"></span></button>
                        <h5 class="modal-title" id="mySmallModalLabel">Nouvel zone</h5>
                    </div>
                    <div class="modal-body">
                        <form action="config" method="post">
                            <input class="form-control" type="text" name="nniveau" id="" placeholder="nom du zone" required="">
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" data-dismiss="modal">Fermer</button>
